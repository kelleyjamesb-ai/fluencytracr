...
Generated: 2026-05-16T02:47:26.953Z
Source dataset: lmsys/lmsys-chat-1m
Backend: http://localhost:4000
Assurance run: verify-mp7qx47k
...
| PASS | `sub_threshold_cohort_suppressed` | {"workflow_id":"lmsys-assurance-verify-mp7qx47k-sub-threshold","disclosure":"SUPPRESSED","suppression_reasons":["insufficient_disclosed_executions"]} |
...
| PASS | `duplicate_execution_ids_isolated_by_org` | {"execution_id":"exec:lmsys-assurance-verify-mp7qx47k-shared-model:run:lmsys-assurance-verify-mp7qx47k-duplicate-shared-run","tenant_a_traces":1,"tenant_b_traces":1} |
| PASS | `audit_log_entries_exist_for_each_suppression` | {"suppressed_workflows":["lmsys-assurance-verify-mp7qx47k-sub-threshold"]} |
