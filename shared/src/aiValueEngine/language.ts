...
const DISPLAY_LABELS: Record<string, string> = {
  ...
  FINANCE_VALIDATED: "Validated Value",
  FINANCE_VALIDATED_EBITA_CASE: "Validated Value",
  VALIDATED_VALUE_REALIZATION: "Validated Value",
  CUSTOMER_FACING_APPROVED: "Renewal Evidence",
