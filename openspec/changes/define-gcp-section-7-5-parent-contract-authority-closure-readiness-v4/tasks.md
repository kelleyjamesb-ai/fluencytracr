...
- [ ] 4.1 Do not create an evaluator before exact-packet unanimous `READINESS_GO`.
- [ ] 4.2 Do not amend a parent or create a closure projection in this packet.
- [ ] 4.3 Do not access GCP, restricted evidence, live keys, provisioning,
  persistence, deployment, qualification, execution, Sections 7.5.2-7.8,
  push, PR, or merge.
