...
## Why
The Claim Packet Export is structurally complete, but QBR prep needs a human-readable view that separates strongest safe language from internal-only and suppressed claims without requiring reviewers to read JSON.
