...
FluencyTracr should govern which AI value claims are admissible. That requires a methodology snapshot registry that records how estimates were produced before Strongest Safe Claim language can expose ROI, payback, or finance-approved value.

## What Changes

- Add a `MSR_2026_05` Methodology Snapshot Registry contract in shared schemas.
- Add synthetic Nielsen-style methodology snapshots for Glean Time-Saves, internal ROI/payback, agentic work placeholder methods, and suppressed unapproved models.
- Wire Strongest Safe Claim generation to methodology approval state so financial claims are capped, caveated, or suppressed when the methodology is not customer-safe.
