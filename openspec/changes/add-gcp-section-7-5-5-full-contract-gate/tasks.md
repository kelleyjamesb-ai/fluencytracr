...
- [x] 1.1 Freeze the complete packet, trust ledger, requirements, attacks, and environment cells.
- [x] 1.2 Add compact adversarial fixtures and prove implementation cases fail only for `MISSING_SUT`.
- [x] 1.3 Freeze and independently review the preimplementation evidence commit.

## 2. Docs-only closure implementation
