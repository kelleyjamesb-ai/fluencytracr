...
VBD_TRAJECTORY_GROUP_EFFECT_MARGINALIZATION_FIT_SCHEMA_VERSION = (
    "FT_AI_VALUE_VBD_GROUP_EFFECT_MARGINALIZATION_DIAGNOSTIC_FIT_2026_07_V2"
)
...
VBD_TRAJECTORY_GROUP_EFFECT_MARGINALIZATION_COMPLETION_SCHEMA_VERSION = (
    "FT_AI_VALUE_VBD_GROUP_EFFECT_MARGINALIZATION_RUNNER_COMPLETION_2026_07_V2"
)
    ...
    *,
    ...
    if (
        ...
        raise PermissionError(
            "completed marginalization fit requires its internal reconstruction token"
        )
...
def build_completed_vbd_trajectory_group_effect_marginalization_record(
    *,
    ...
    """Validate a completion-bound HOLD record; no launcher is provided here."""
    ...
    if (
        ...
        raise PermissionError(
            "completed marginalization record requires its internal reconstruction token"
        )
    fits = _validate_fit_matrix(fit_records)
